...
\label{limitations}
		%TODO Adam: added the reason for the reduction in the numbers, and accept that we do not have the data to quantify about captcha/csrf
		...
		We attribute the difference in the number of forms found to the number of forms fuzzed to the presence of bot-blocking mechanisms on a website, though we do not know what percentage was caused by CAPTCHAs, CSRF tokens, and hidden fields individually.
